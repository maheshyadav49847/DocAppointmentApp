...
namespace CodeX.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260917191815_AddUniversalLeaveManagement")]
    partial class AddUniversalLeaveManagement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeX.Domain.Entities.LeaveRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("AffectedTokensCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("NotifyPatients")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("OrganizationId", "DoctorId", "StartDate", "EndDate", "Status")
                        .HasDatabaseName("IX_LeaveRecords_Doctor_Dates_Status");

                    b.HasIndex("OrganizationId", "StaffId", "StartDate", "EndDate", "Status")
            ...
            modelBuilder.Entity("CodeX.Domain.Entities.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Channel", "Status", "Priority", "CreatedAt", "NextRetryAtUtc", "IsDeleted")
