            ...
            { "2", new Dictionary<string, string> // MARATHI
                {
                    ...
                    { "INVALID_INPUT", "⚠️ क्षमस्व, आम्हाला समजले नाही.\n\nजर तुम्हाला ही प्रोसेस थांबवून परत मेनूवर जायचे असेल, तर कृपया *9* लिहून पाठवा.\n\nकिंवा योग्य पर्याय (उदा: 1, 2) निवडा." },
                    { "INVALID_INPUT_HELP", "🆘 ही प्रोसेस थांबवून मेनूवर परत जाण्यासाठी *9* लिहून पाठवा." },
            ...
            { "3", new Dictionary<string, string> // ENGLISH
                {
                    ...
                    { "INVALID_INPUT", "⚠️ Sorry, we didn't understand that.\n\nIf you want to discontinue this process and return to the main menu, please reply with *9*.\n\nOtherwise, reply with a valid number (e.g., 1 or 2)." },
                    { "INVALID_INPUT_HELP", "🆘 To discontinue and return to the main menu, please reply with *9*." },
