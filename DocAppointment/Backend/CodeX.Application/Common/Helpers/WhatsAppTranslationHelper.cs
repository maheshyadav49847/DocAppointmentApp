            ...
            { "1", new Dictionary<string, string> // HINDI
                {
                    ...
                    { "INVALID_INPUT", "⚠️ क्षमा करें, हमें समझ नहीं आया।\n\nकृपया दिए गए विकल्पों में से सही नंबर (जैसे: 1, 2, 3) लिखकर भेजें।" },
                    { "INVALID_INPUT_HELP", "🆘 मेनू पर वापस जाने के लिए *HI* लिखकर भेजें।" },
            ...
            { "2", new Dictionary<string, string> // MARATHI
                {
                    ...
                    { "INVALID_INPUT", "⚠️ क्षमस्व, आम्हाला समजले नाही.\n\nकृपया दिलेल्या पर्यायांमधून योग्य नंबर (उदा: 1, 2, किंवा 3) लिहून पाठवा." },
                    { "INVALID_INPUT_HELP", "🆘 मेनूवर परत जाण्यासाठी *HI* लिहून पाठवा." },
                    { "RATING_PROMPT", "🌟 तुमची तपासणी पूर्ण झाली आहे!\n\nकृपया तुमचा अनुभव कसा होता हे सांगण्यासाठी 1 ते 5 मधील एक नंबर पाठवा:\n\n5️⃣ - खूप छान (Excellent)\n4️⃣ - छान (Good)\n3️⃣ - ठीक (Average)\n2️⃣ - वाईट (Poor)\n1️⃣ - खूप वाईट (Terrible)\n\n👉 (फक्त एक नंबर लिहून पाठवा)" },
                    { "COMMENT_PROMPT", "🙏 खूप खूप धन्यवाद!\n\nतुम्हाला काही सूचना द्यायची असल्यास कृपया इथे लिहा.\nकिंवा हे सोडण्यासाठी *SKIP* लिहून पाठवा." },
                    { "FEEDBACK_SUCCESS", "❤️ तुमच्या मोलाच्या सूचनेबद्दल धन्यवाद!\n\nतुमचे आरोग्य आमच्यासाठी सर्वात महत्त्वाचे आहे. निरोगी राहा! 😊" },
                    { "EMERGENCY_ALERT", "🚨 *मेडिकल इमर्जन्सी*\n\nकृपया त्वरित जवळच्या रुग्णालयात जा किंवा रुग्णवाहिका बोलवा.\n\n⚠️ हा WhatsApp नंबर इमर्जन्सीसाठी नाही." },
            ...
            { "3", new Dictionary<string, string> // ENGLISH
                {
                    ...
                    { "INVALID_INPUT", "⚠️ Sorry, we didn't understand that.\n\nPlease reply with a valid number from the options (e.g., 1, 2, or 3)." },
                    { "INVALID_INPUT_HELP", "🆘 Type *HI* to restart the menu." },
