...
import { LayoutDashboard, Users, Stethoscope, Pill, Clock, Settings, Menu, LogOut, Bell, Activity, X, Building2, UserCog, Key, ChevronRight, Home, FileText, MonitorPlay, MessageSquare, CheckCircle, Save, ReceiptIndianRupee, BarChart3, MapPin, GitCommitHorizontal, Inbox } from "lucide-react"
...
const getNavigation = (role: string, isDoctor: boolean) => {
  let nav = [
    ...
    { name: "Patient Journey", href: "/lifecycle", icon: GitCommitHorizontal, requiredAny: ["Queue.View", "Analytics.View"] },
