        ...
        {totalCount > 0 && (
          <div className="p-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            <div className="flex items-center gap-4 flex-wrap">
              <span>
                Showing <strong className="text-slate-700 font-semibold">{(page - 1) * pageSize + 1}</strong> to{' '}
                <strong className="text-slate-700 font-semibold">{Math.min(page * pageSize, totalCount)}</strong> of{' '}
                <strong className="text-slate-700 font-semibold">{totalCount}</strong> messages
              </span>
