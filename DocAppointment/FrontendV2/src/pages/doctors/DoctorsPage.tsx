...
<div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="col-span-1 sm:col-span-2">
                          <label className="flex items-center gap-2 text-sm font-medium text-zinc-700 mb-1">
                            <ShieldCheck className="w-4 h-4 text-teal-500" /> Registration No. <span className="text-red-500">*</span>
                          </label>
                          <input required autoComplete="off" name="registrationNumber" defaultValue={editingDoctor?.registrationNumber} className="w-full px-3 py-2 bg-white border border-zinc-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all" placeholder="MCI-12345" />
